...
png(sprintf("plots/plot7_%s.png", shop.id))
bgnbd.PlotFrequencyInCalibration(params, cal.cbs, censor)
dev.off()
png(sprintf("plots/plot8_%s.png", shop.id))
bgnbd.PlotTransactionRateHeterogeneity(params)
dev.off()
png(sprintf("plots/plot9_%s.png", shop.id))
bgnbd.PlotDropoutRateHeterogeneity(params)
dev.off()

png(sprintf("plots/plot60_%s.png", shop.id))
...
png(sprintf("plots/plot5_%s.png", shop.id))
...
png(sprintf("plots/plot6_%s.png", shop.id))
...
#         t.x = 20, T.cal = 39)
#     cat ("x:",i,"\t Expectation:",cond.expectation, fill = TRUE) }
png(sprintf("plots/plot7-1_%s.png", shop.id))
pnbd.PlotFrequencyInCalibration(params, cal.cbs, censor)
dev.off()
png(sprintf("plots/plot8-1_%s.png", shop.id))
pnbd.PlotTransactionRateHeterogeneity(params)
dev.off()
png(sprintf("plots/plot9-1_%s.png", shop.id))
...
png(sprintf("plots/plot60-1_%s.png", shop.id))
...
png(sprintf("plots/plot5-1_%s.png", shop.id))
inc.tracking <- pnbd.PlotTrackingInc(params, T.cal,
                                     T.tot, w.track.data,
                                     n.periods.final)
dev.off()
png(sprintf("plots/plot6-1_%s.png", shop.id))
...
png(sprintf("plots/plot61_%s.png", shop.id))
