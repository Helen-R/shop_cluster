...
shop.id <- 14
fnm <- sprintf("dt.dly_%s.RData", shop.id)
load(fnm)
...
png(sprintf("plots/BTYD_14_monthly_series_104wks/plot7_%s_%s.png", shop.id, as.character(start.date)))
bgnbd.PlotFrequencyInCalibration(params, cal.cbs, censor)
dev.off()
png(sprintf("plots/BTYD_14_monthly_series_104wks/plot8_%s_%s.png", shop.id, as.character(start.date)))
bgnbd.PlotTransactionRateHeterogeneity(params)
dev.off()
png(sprintf("plots/BTYD_14_monthly_series_104wks/plot9_%s_%s.png", shop.id, as.character(start.date)))
bgnbd.PlotDropoutRateHeterogeneity(params)
dev.off()

png(sprintf("plots/BTYD_14_monthly_series_104wks/plot60_%s_%s.png", shop.id, as.character(start.date)))
...
png(sprintf("plots/BTYD_14_monthly_series_104wks/plot5_%s_%s.png", shop.id, as.character(start.date)))
...
png(sprintf("plots/BTYD_14_monthly_series_104wks/plot6_%s_%s.png", shop.id, as.character(start.date)))
...
# #         t.x = 20, T.cal = 39)
# #     cat ("x:",i,"\t Expectation:",cond.expectation, fill = TRUE) }
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot7-1_%s_%s.png", shop.id, as.character(start.date)))
# pnbd.PlotFrequencyInCalibration(params, cbs, censor)
# dev.off()
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot8-1_%s_%s.png", shop.id, as.character(start.date)))
# pnbd.PlotTransactionRateHeterogeneity(params)
# dev.off()
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot9-1_%s_%s.png", shop.id, as.character(start.date)))
...
# # }
# 
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot60-1_%s_%s.png", shop.id, as.character(start.date)))
...
# result.ls <- c(result.ls, list(comp))
# 
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot5-1_%s_%s.png", shop.id, as.character(start.date)))
# inc.tracking <- pnbd.PlotTrackingInc(params, T.cal,
#                                      T.tot, w.track.data,
#                                      n.periods.final)
# dev.off()
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot6-1_%s_%s.png", shop.id, as.character(start.date)))
...
# png(sprintf("plots/BTYD_14_monthly_series_104wks/plot61_%s_%s.png", shop.id, as.character(start.date)))
...
system("zip BTYD_14_monthly_series_104wks plots/BTYD_14_monthly_series_52wks/*")
...
# gcs_list_objects()
gcs_upload("BTYD_14_monthly_series_52wks.zip")
